...
function Invitation(props) {
  ...
  return (
    <div className="grid grid-cols-1 gap-3 p-3 min-h-[90vh] w-[90%] border-cyan-600 border-x-4 border-y-4 mx-auto bg-gradient-to-tr from-[#A9F1DF] to-[#FFBBBB] rounded-lg shadow-lg">
      {/* Header Section */}
